...
namespace Quartz.Net_RemoteServer
{
    public class QuartzServer : ServiceControl
    {
        ...
        protected void QuartzConfig()
        {
            ...
            properties["quartz.scheduler.exporter.type"] = "JobManager_RemoteServer.RemotingSchedulerExporterOverrided.RemotingSchedulerExporterOverrided, JobManager_RemoteServer";
